...
int colors()
{
	...
	// create shaders
	Shader shader("vertex_shaders/basic_lighting.vs", "fragment_shaders/materials.fs");
	Shader lightCubeShader("vertex_shaders/lightCube.vs", "fragment_shaders/lightCube.fs");
